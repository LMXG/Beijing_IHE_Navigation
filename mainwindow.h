...
public slots:
    ...
    //动作添加景点槽函数
    void on_actionAddSpot_triggered();
    //动作添加连接槽函数
...
protected:
    ...
    //绘制网络图的景点节点
    void drawSpots (const QList<int>& spotsList);
...
#define NET_WIDTH 2500      //网络图最大宽度
#define NET_HEIGHT 2500     //网络图最大高度
#define SCENE_WIDTH (LINE_INFO_WIDTH+MARGIN*2+NET_WIDTH)    //视图宽度
#define SCENE_HEIGHT (MARGIN*2+NET_HEIGHT)                  //视图高度
#define EDGE_PEN_WIDTH 15    //路线边宽
#define NODE_HALF_WIDTH 20   //节点大小
